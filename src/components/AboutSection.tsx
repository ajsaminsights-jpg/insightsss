        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                His thought leadership in governance frameworks and his commitment to developing next-generation audit professionals has made him a sought-after speaker and mentor in the industry.
              </p>
            </div>
